...
PLACE = {
    ...
    'C1': (26.2, 12.9, 0), 'R2': (28.2, 16.2, 90), 'R1': (30.8, 14.9, 0), 'D1': (33.2, 16.4, 90), 'TP7': (28.2, 19.2, 0),
    # VREF, AVDD decoupling
    'C4': (24.0, 11.0, 90), 'C19': (24.9, 9.0, 0), 'C20': (26.9, 9.0, 0),
    # crystal
    'Y1': (23.5, 17.4, 0), 'C2': (21.0, 21.2, 90), 'C3': (25.7, 21.2, 90),
    # MVDD / PVDD decoupling
    'C17': (19.2, 15.4, 0), 'C18': (19.2, 16.7, 0), 'C21': (22.6, 14.4, 0), 'C22': (24.5, 14.4, 0),
    # DVDDIO / DVDD decoupling (left of U1)
    'C14': (15.4, 7.9, 0), 'C13': (15.4, 9.2, 0), 'C15': (15.4, 10.5, 0), 'C16': (15.4, 11.8, 0),
    # control (top)
    'R4': (17.3, 5.9, 90), 'R5': (18.8, 5.9, 90), 'R3': (20.3, 5.9, 90), 'C5': (21.8, 5.9, 90), 'TP5': (24.6, 6.4, 0),
    'JP3': (13.5, 2.7, 0), 'JP1': (19.0, 2.7, 0), 'JP2': (24.6, 2.7, 0),
    # power (bottom-left)
    'U2': (11.5, 22.0, 0), 'C6': (7.6, 24.9, 0), 'C7': (15.3, 20.8, 0), 'C8': (15.3, 22.6, 0), 'TP1': (9.0, 18.6, 0), 'TP2': (18.6, 21.7, 0),
    'U3': (11.5, 27.0, 0), 'C9': (15.3, 25.8, 0), 'C10': (15.3, 27.6, 0), 'FB1': (18.4, 25.8, 0), 'C11': (21.4, 25.8, 0), 'TP8': (18.4, 28.3, 0),
    'R6': (7.5, 26.8, 0), 'R7': (7.5, 28.4, 0), 'TP3': (6.6, 30.4, 0), 'TP4': (9.2, 30.4, 0), 'TP6': (31.5, 29.6, 0),
